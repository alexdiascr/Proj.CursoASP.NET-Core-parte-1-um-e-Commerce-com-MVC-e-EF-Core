...
namespace CasaDoCodigo.Repositories
{
    ...
    public class PedidoRepository : BaseRepository<Pedido>, IPedidoRepository
    {
        ...
        public Pedido GetPedido()
        {
            ...
            //SingleOrDefault - caso encontrar, traz o pedido, caso não,
            //traz null sem dá um erro.
            var pedido = dbSet
                .Include(p => p.Itens)
        ...
        {
            return contextAccessor.HttpContext.Session.GetInt32("pedidoId"); //Id salvo na session
        }
